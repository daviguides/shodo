...
# --- Configuration ---
readonly REPO_URL="https://github.com/daviguides/shodo.git"
readonly TMP_DIR="/tmp/shodo-$$"
readonly CLAUDE_DIR="$HOME/.claude"
readonly TARGET_DIR="$CLAUDE_DIR/shodo"
readonly SOURCE_SUBDIR="shodo"

# --- Marketplace Configuration ---
readonly MARKETPLACE_URL="https://github.com/daviguides/claude-marketplace.git"
readonly PLUGIN_IDENTIFIER="shodo@daviguides"
...
install() {
  ...
  copy_files &
  local pid=$!
  spinner $pid "Installing to ~/.claude/shodo..."
  wait $pid

  status_ok "Plugin installed to ~/.claude/shodo"
}
